      ...
      <div className="p-12 lg:p-36">
        ...
        <div className="flex items-center justify-between">
          <div className="w-full flex items-center justify-center flex-col">
            ...
            <h1 className="text-2xl text-center lg:text-6xl font-bold text-black">Meet our team</h1>
            <p className="text-md text-center lg:text-2xl text-gray-500 my-5 max-w-3xl leading-6">
              “We suffer more often in imagination than in reality.” ~ Seneca
            </p>
          </div>
        </div>
        ``
        <div className="flex w-full items-center justify-around flex-col gap-4 lg:flex-row">
